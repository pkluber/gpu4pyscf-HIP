                        ...
                        uint32_t *batch_head, int *scheme, int workers)
{
    ...
    case 131:
        ...
        hipFuncSetAttribute(rys_ejk_ip2_type3_1011, hipFuncAttributeMaxDynamicSharedMemorySize, buflen*sizeof(double));
    ...
    case 155:
        buflen += (g_size * 3 + 9) * nsq_per_block;
        hipFuncSetAttribute(rys_ejk_ip2_type3_1110, hipFuncAttributeMaxDynamicSharedMemorySize, buflen*sizeof(double));
        rys_ejk_ip2_type3_1110<<<workers, threads, buflen*sizeof(double)>>>(*envs, *jk, *bounds, pool, dd_pool, batch_head); break;
    case 156:
        buflen += (g_size * 3 + 9) * nsq_per_block;
        hipFuncSetAttribute(rys_ejk_ip2_type3_1111, hipFuncAttributeMaxDynamicSharedMemorySize, buflen*sizeof(double));

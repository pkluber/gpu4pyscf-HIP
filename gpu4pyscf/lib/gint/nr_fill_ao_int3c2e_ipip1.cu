...
__host__
static int GINTfill_int3c2e_ipip1_tasks(ERITensor *eri, BasisProdOffsets *offsets, GINTEnvVars *envs, hipStream_t stream)
{
...
extern "C" {
int GINTfill_int3c2e_ipip1(hipStream_t stream, BasisProdCache *bpcache, double *eri, int nao,

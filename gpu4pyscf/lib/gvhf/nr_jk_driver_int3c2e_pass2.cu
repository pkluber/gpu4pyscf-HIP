...
__host__
static int GINTrun_tasks_int3c2e_pass2_j(JKMatrix *jk, BasisProdOffsets *offsets, GINTEnvVars *envs, hipStream_t stream)
{
...
extern "C" { __host__
int GINTbuild_j_int3c2e_pass2(hipStream_t stream, BasisProdCache *bpcache,
